...
async function doIt() {
    ...
    if (!exists) {
        ...
        body += `This PR will be closed for now.\n\n`;
        ...
        body += `Dieser PR wird vorübergehend geschlossen.\n\n`;
        ...
        body += `Überprüfen, dass alle Fehler behoben sind.\n\n`;

        body += `**KEINEN NEUEN PR ERSTELLEN, BEVOR ALLE FEHLER BEHOBEN SIND**\n\n`;
