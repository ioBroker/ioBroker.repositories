...
const { addComment, addLabel, deleteComment, deleteLabel, getAllComments, getGithub } = require('../src/common.mts');
...
const ERROR_EXPLANATIONS = {
    ...
    E6001: {
        en: 'An i18n object (e.g. `common.name` or `common.desc`) is missing one or more *recommended*'
          ...
          + '**Fix:** Add translations for the languages listed in the message.'
          + ' A translationtool is available at https://translator-ui.iobroker.in/. Using i18n support modules at adapter-core is another option.',
        de: 'Ein i18n-Objekt (z. B. `common.name` oder `common.desc`) enthält nicht alle *empfohlenen*'
          ...
          + '**Lösung:** Füge Übersetzungen für die in der Meldung aufgeführten Sprachen hinzu.'
          + ' Auf https://translator-ui.iobroker.in/ stellt ein Toole zur Übersetzung zur Verfügung. Altrnativ können die i18n Module des Adaptercores verwendet werden.',
    },
