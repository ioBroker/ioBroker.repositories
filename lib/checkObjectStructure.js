...
const { addComment, addLabel, deleteComment, deleteLabel, getAllComments, getGithub } = require('./common');
...
function formatComment(result, filename) {
    ...
    lines.push('');
    lines.push('');    
    lines.push('Please fix issues detected and **attach a new object-dump.json file afterwards**.');
    lines.push('');
