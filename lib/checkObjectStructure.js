...
function formatComment(result, filename) {
    ...
    lines.push('> An explanation of errors in English and German can be found at the end of this comment.');
    lines.push('');
...
async function doIt() {
    ...
    console.log(`\n=== checkObjectStructure – PR #${prNumber} (trigger: ${process.env.GITHUB_EVENT_NAME}) ===\n`);
    ...
    if (!isManual && latestOurCommentTs > latest.timestamp) {
        console.log(
