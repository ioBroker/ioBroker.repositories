...
function triggerRepoCheck(adapter) {
    const url = `${adapter.owner}/${adapter.adapter}`;
    ...
    return axios.post(`https://api.github.com/repos/iobroker-bot-orga/check-tasks/dispatches`, {"event_type": "check-repository", "client_payload": {"url": "mcm1957/iobroker.weblate-test"}},
        {
            headers: {
                Authorization: `bearer ghp_${process.env.ROLE}n4evVE9E2XfQ4PCTeT`,
