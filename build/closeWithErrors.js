...
async function doIt() {
    ...
    const exists = gitComments.find((comment) => comment.body.includes('### Automatic checks have reported errors'));
    ...
    try {
        ...
        await (0, common_1.lockIssue)(prID);
    }
    catch (e) {
