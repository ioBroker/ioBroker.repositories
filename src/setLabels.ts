...
import { addLabel, deleteLabel, getLabels, getGithub } from './common';
...
async function addLabels(prID: string, labels: string[]) {
...
async function delLabels(prID: string, labels: string[]) {
